...
style lets you customize the appearance.
...
Quarto extensions allow you to customize fonts, colors, spacing, page layout, and document branding to create a consistent look and feel across projects. Explore the
<a href="https://github.com/bhelsel/quarto-kansas"
   style="color:#0055A4; font-weight:bold;">
quarto-kansas
</a>
repository for an example of a custom Quarto extension.
...
For a complete example of manuscript writing and citation management in Quarto, explore the
<a href="https://github.com/bhelsel/quarto-manuscript"
   style="color:#0055A4; font-weight:bold;">
quarto-manuscript
</a>
template.
...
<video data-autoplay controls="controls" width="900" height="500" name="Shiny RevealJS">
  <source src="https://bhelsel.github.io/presentationsR/inst/videos/ShinyRevealJS.mp4">
</video>
...
**Step 3:** Create an <code>_extensions.yml</code> and <code>custom.css</code> file inside the rlab folder.

**Step 4:** Add the following yaml to <code>_extensions.yml</code>:
...
**Step 5:** Add the format and extension to the yaml of the <code>communication.qmd</code> file.
```yaml
---
format:
  rlab-html: default
...
**Step 6:** Copy the CSS from
<a href="https://github.com/bhelsel/2026-RLAB-Practical-Exercises/tree/main/attendees/MorganBrucks/code/_extensions/rlab/custom.css"
   style="color:#0055A4; font-weight:bold;">
this <code>custom.css</code> file
</a>
into the <code>custom.css</code> file that you just created.

**Step 7:** *Optional*. Experiment with ths css styling in <code>custom.css</code> by changing the images, colors, font sizes, etc. to make it your own.
